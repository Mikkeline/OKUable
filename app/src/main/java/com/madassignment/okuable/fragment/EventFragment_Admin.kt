...
import com.madassignment.okuable.adapter.rejectEvent
...
class EventFragment_Admin : Fragment() {
    ...
    private var rAdapter: rejectEvent? = null
    //private var rAdapter: rejectEvent? = null
        ...
        binding.viewReject.setOnClickListener {
            ...
            db.collection("Event").get()
                .addOnSuccessListener { documents ->
                    ...
                    rAdapter = rejectEvent(appContext, eventList)
                    rvEvents.adapter = rAdapter
