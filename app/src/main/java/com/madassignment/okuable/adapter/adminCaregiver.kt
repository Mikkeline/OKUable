...
class adminCaregiver (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, i: Int): adminCaregiver.ViewHolder {
        val itemView = LayoutInflater.from(context).inflate(R.layout.caregiver_item_admin, parent,false)
    ...
    override fun onBindViewHolder(viewHolder: adminCaregiver.ViewHolder, i: Int) {
