...
class jobRejectAdapter (
    val context: Context,
    private var caregivers: ArrayList<CaregiverList>
) :
    RecyclerView.Adapter<jobRejectAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, i: Int): jobRejectAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(viewHolder: jobRejectAdapter.ViewHolder, i: Int) {
